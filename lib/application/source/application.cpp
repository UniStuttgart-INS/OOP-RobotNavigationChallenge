...
void Application::RecreateFontAtlas()
{
    ...
    io.Fonts->AddFontFromMemoryCompressedTTF(PlayRegular_compressed_data, PlayRegular_compressed_size, 26.0F, &config);
    strcpy(config.Name, "Inconsolata Big");
    io.Fonts->AddFontFromMemoryCompressedTTF(InconsolataNerdFontComplete_compressed_data, InconsolataNerdFontComplete_compressed_size, 42.0F, &config);
